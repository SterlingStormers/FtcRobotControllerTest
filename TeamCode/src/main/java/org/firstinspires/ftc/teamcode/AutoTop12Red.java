...
@Autonomous(name = "Auto Top 12 Red", group = "Autonomous")
@Configurable // Panels
public class AutoTop12Red extends OpMode {
        ...
        public Paths(Follower follower) {
            ...
            Path9 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(89.879, 89.944),
                                    new Pose(77.292, 35.081),
                                    new Pose(110.694, 35.242)
                            )
                    )
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            Path10 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(110.694, 35.242), new Pose(128.121, 35.404))
                    )
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            Path11 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(128.121, 35.404),
                                    new Pose(93.913, 40.406),
                                    new Pose(89.879, 89.944)
                            )
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(360), Math.toRadians(42))
            ...
            Path12 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(89.879, 89.944), new Pose(81.004, 101.562))
                    )
