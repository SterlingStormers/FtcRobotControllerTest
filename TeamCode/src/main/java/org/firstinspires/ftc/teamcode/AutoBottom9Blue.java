...
@Autonomous(name = "Auto Bottom 9 Blue", group = "Autonomous")
@Configurable // Panels
public class AutoBottom9Blue extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path9 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(53.249, 90.105), new Pose(64.383, 99.787))
                    )
