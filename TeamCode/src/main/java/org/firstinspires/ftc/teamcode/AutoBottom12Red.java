...
@Autonomous(name = "Auto Bottom 12 Red", group = "Autonomous")
@Configurable // Panels
public class AutoBottom12Red extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(87.458, 8.133), new Pose(72.000, 72.000))
                    )
            ...
            Path6 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(89.879, 89.782),
                                    new Pose(92.944, 60.092),
                                    new Pose(109.887, 59.769)
                            )
                    )
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            Path7 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(109.887, 59.769), new Pose(128.928, 59.769))
                    )
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            Path8 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(128.928, 59.769),
                                    new Pose(100.044, 59.769),
                                    new Pose(89.879, 89.782)
                            )
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(360), Math.toRadians(42))
            ...
            Path9 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(89.879, 89.782),
                                    new Pose(84.715, 35.565),
                                    new Pose(109.887, 35.565)
                            )
                    )
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            Path10 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(109.887, 35.565), new Pose(128.928, 35.242))
                    )
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            Path11 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(128.928, 35.242),
                                    new Pose(95.526, 40.890),
            ...
            Path12 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(89.879, 89.944), new Pose(77.776, 101.400))
                    )
