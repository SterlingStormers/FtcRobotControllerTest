...
@Autonomous(name = "Auto Bottom 6 Red", group = "Autonomous")
@Configurable // Panels
public class AutoBottom6Red extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path6 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(89.879, 89.782), new Pose(76.970, 97.205))
                    )
