...
@Autonomous(name = "Auto Bottom 9 Red", group = "Autonomous")
@Configurable // Panels
public class AutoBottom9Red extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path9 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(89.879, 89.782), new Pose(76.970, 99.948))
                    )
